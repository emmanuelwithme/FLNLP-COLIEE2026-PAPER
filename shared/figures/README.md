...
- `task1_system_pipeline_common.tex`
- `task1_system_pipeline_en.tex`
- `task1_system_pipeline_zh.tex`

The paper should generally include the rendered `PDF` version via `\includegraphics`.
